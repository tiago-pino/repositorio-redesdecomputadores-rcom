...
*/
            ...
            while(STOP==FALSE){
                ...
                ///////////
                statemachine_RR1_REJ1(valor_lido);printf("                  Olá1 :%x__:%d\n",valor_lido,state);
                printf("STATE IS: %d\n",state);
...
*/    
            ...
            while(STOP==FALSE){
                ...
                ///////////
                statemachine_RR0_REJ0(valor_lido);printf("                  Olá1 :%x__:%d\n",valor_lido,state);
                printf("STATE IS: %d\n",state);
                if(state==STOP_STATE_MACHINE){
                    if(reject==0){  //Verifiico se recebi RR(reject==0) ou REJ(reject==1) para reenviar o I(frame de dados)
                        STOP=TRUE;
...
/*                    alarm(0);   */        //Para parar o alarme
            ...
            while(STOP==FALSE){
                ...
                BCC2_anterior=BCC2;
                BCC2=BCC2^packet[i];//if(BCC2==0x4f){printf("BCC2 encontrado\n");}
                i++;
            }
